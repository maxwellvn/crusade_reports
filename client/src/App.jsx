...
const PAGE_META = [
  ...
  [/^\/mystreamspace\/update\//, "Update MyStreamSpace Totals", "Authorised MyStreamSpace reporting form.", false],
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/mystreamspace/update/:token" element={<MyStreamSpaceUpdateForm />} />
        ...
        <Route element={<AdminGate><Shell subtitle="Crusade analytics and records."
          ...
          <Route path="/dashboard/duplicate-reports" element={<SettingsRoute><DuplicateReports /></SettingsRoute>} />
          ...
          <Route path="/dashboard/zone-checklist" element={<PageGuard pageKey="dashboard/pastoral-checklist"><PastoralChecklist /></PageGuard>} />
          <Route path="/dashboard/pastoral-checklist" element={<Navigate to="/dashboard/zone-checklist" replace />} />
