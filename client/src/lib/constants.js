...
export const CRUSADE_TYPES = [
  ...
  ["tap2read", "TAP2read Outreach"],
  ["rabah", "Rabah Cellular Outreach"],
  ["youths-aglow", "Youths Aglow Outreach"],
  ["teevolution", "Teevolution Outreach (Teens)"],
  ["say-yes-to-kids", "Say Yes To Kids Outreach"],
  ["nolb", "No One Left Behind Outreach"],
  ["leading-ladies", "Leading Ladies Outreach"],
  ["mighty-men", "Mighty Men Outreach"],
  ["professionals", "Specialized Outreach to Professionals"],
  ["tv", "TV Crusades"],
  ...
  ["hospital", "Hospital Outreach"],
  ["street", "Street Outreach"],
  ["prison", "Prison Outreach"],
  ["transport-station", "Transport Station Outreach"],
  ["village", "Village Outreach"],
  ["community", "Community Outreach"],
  ["football", "Football Stadium Outreach"],
