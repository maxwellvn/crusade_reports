  ...
  function exportWord() {
    ...
    downloadNotcReportDocx({
      ...
      columns: [
        ...
        { header: "Preferred nations", value: (row) => row.mission_country_names.join(", "), width: 1800 },
