...
import { ArrowUpDown, Download, FileSpreadsheet, Search, Trash2, X } from "lucide-react";
    ...
    <section className="border-t border-slate-200 py-8 sm:py-10">
      ...
      <div className="mt-6 border-y border-slate-200 py-5">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-6">
          ...
          <Field label="Zone home nation"><Select value={filters.home_country} onChange={(event) => setFilter("home_country", event.target.value)}><option value="">Any home nation</option>{nations.map((nation) => <option key={nation.code} value={nation.code}>{nation.name}</option>)}</Select></Field>
