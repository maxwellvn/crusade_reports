...
function Receipt({ receipt }) {
  return <div className="min-h-screen bg-white">
    ...
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
      ...
      <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600">This receipt confirms the zone's mission-nation preference. The final assignment will be made by the NOTC administration.</p>
...
export function MissionNationSelection() {
  ...
  return <div className="min-h-screen bg-white">
    <header className="border-b border-slate-200"><div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-4 sm:px-6"><Link to="/"><img src="/logo.png" alt="" className="h-11 w-auto" /></Link><span className="hidden text-sm font-semibold text-slate-950 sm:block">National Missions Leadership Initiative</span><Link to="/" className="ml-auto text-sm font-semibold text-slate-700 hover:text-slate-950">Return home</Link></div></header>
    <main>
      <section className="border-b border-slate-200 bg-slate-950 text-white"><div className="mx-auto grid max-w-6xl lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-center"><div className="px-4 py-12 sm:px-6 sm:py-20"><h1 className="max-w-5xl text-4xl font-normal leading-[1.02] tracking-[-0.035em] sm:text-6xl"><span className="mb-4 block text-sm font-semibold leading-5 tracking-normal text-blue-300">NIGHT OF A THOUSAND CRUSADES (NOTC) –</span>NATIONAL MISSIONS LEADERSHIP INITIATIVE</h1><p className="mt-6 max-w-3xl text-lg font-medium text-white">One Lead Zonal Pastor. One Nation. One Mission. Thousands of Crusades.</p><p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">Each Zonal Pastor may express interest in a mission nation outside their zone's home nation. Where multiple zones share works or interests, the NOTC administration will appoint the Lead Regional or Zonal Pastor.</p></div><div className="bg-white lg:mr-6"><img src="/national-missions-leadership.png" alt="NOTC National Missions Leadership Initiative" className="aspect-square w-full object-contain" /></div></div></section>
