...
export function MissionNationSelection() {
  ...
  return <div className="min-h-screen bg-white">
    ...
    <main>
      <section className="border-b border-slate-200 bg-slate-950 text-white"><div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-20"><h1 className="max-w-5xl text-4xl font-normal leading-[1.02] tracking-[-0.035em] sm:text-6xl"><span className="mb-4 block text-sm font-semibold leading-5 tracking-normal text-blue-300">NIGHT OF A THOUSAND CRUSADES (NOTC) –</span>NATIONAL MISSIONS LEADERSHIP INITIATIVE</h1><p className="mt-6 max-w-2xl text-lg font-medium text-white">Choose a nation. Lead 1,000 crusades.</p><p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">Zonal Pastors may express interest in one mission nation outside their zone's home nation. Each preference carries a proposed commitment of at least 1,000 crusades, with final assignments made by the NOTC administration.</p></div></section>
