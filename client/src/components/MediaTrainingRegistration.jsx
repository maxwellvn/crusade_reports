...
const ROLES = ["Presenter", "Cameraman", "Technical Personnel"];
...
export function MediaTrainingRegistration() {
  ...
  const { register, control, setValue, watch, handleSubmit, formState: { errors, isSubmitting } } = useForm({ resolver: zodResolver(mediaTrainingRegistrationSchema), defaultValues: { zone_name: "", group_name: "", church_name: "", full_name: "", role: "", email: "", kingschat_username: "", phone_country_code: "", phone_number: "" }, mode: "onBlur" });
