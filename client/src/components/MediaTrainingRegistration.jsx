...
function LanguagesInput({ value = [], onChange, invalid }) {
  ...
  return <div className={`flex min-h-11 flex-wrap items-center gap-2 border-b border-input py-1.5 ${invalid ? "border-destructive" : ""}`}>
