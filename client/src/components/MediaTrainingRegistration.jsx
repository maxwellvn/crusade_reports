...
export function MediaTrainingRegistration() {
  ...
  return <div className="min-h-screen bg-white">
    ...
    <main className="mx-auto grid max-w-6xl lg:grid-cols-[23rem_minmax(0,1fr)]">
      <aside className="bg-slate-950 text-white lg:min-h-[calc(100vh-77px)]"><h1 className="sr-only">NIGHT OF A THOUSAND CRUSADES (NOTC) GLOBAL MEDIA TRAINING MOBILISATION</h1><img src="/media-training-mobilisation.png" alt="Night of a Thousand Crusades Global Media Training Mobilisation" className="aspect-square w-full object-cover" /><div className="space-y-5 px-5 py-8 text-sm sm:px-8"><p className="flex gap-3"><CalendarDays className="size-5 text-blue-300" /><span><strong className="block text-white">August 24, 2026</strong><span className="text-slate-400">Global training day</span></span></p><p className="flex gap-3"><UserRound className="size-5 text-blue-300" /><span><strong className="block text-white">Individual registration</strong><span className="text-slate-400">Each trainee completes this form personally</span></span></p></div></aside>
