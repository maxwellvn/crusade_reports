...
const CRUSADES = [
  ...
  { code: "CG", nation: "Congo - Brazzaville", dates: "28 Aug", names: "Makelele City Wide Crusade", types: "Mega Crusade", cities: "Brazzaville" },
  ...
  { code: "FJ", nation: "Fiji", dates: "29 Aug & 5 Sep", names: "Rhapsody End-Time Crusade; Rhapsody End-Time Crusade", types: "Crusades", cities: "Sigatoka, Nadi" },
  { code: "FR", nation: "France", dates: "15 Aug", names: "Eiffel Tower Crusade", types: "Street Crusade", cities: "Paris" },
  ...
  { code: "IN", nation: "India", dates: "23 Aug", names: "Rhapsody End-Time Crusade, India", types: "Mega Crusade", cities: "Chennai" },
  ...
  { code: "KE", nation: "Kenya", dates: "12 Aug, 21 Aug, 23 Aug, 23 Aug, 27 Aug, 27 Aug, 28 Aug, 30 Aug, 4 Sep & 6 Sep", names: "Kakamenga County Crusade; Youth Aglow Crusade; Kisii University Crusade (Youth Crusade); Rongo University Crusade (Youth Crusade); Kodiaga Prison Crusade; Kitale Prison Crusade; Kisumu Prophetic Crusade; Tom Mboya University (Youth Crusade); Great Lakes University Crusade (Youth Crusade); Jaramogi Oginga Odinga University Crusade (Youth Crusade)", types: "Street; Youths Aglow; Prison; Mega Crusades", cities: "Kakamega, Kisumu, Kisii, Rongo, Kisumu, Kitale, Kisumu, Homa Bay Town, Kisumu, Bondo" },
  { code: "MW", nation: "Malawi", dates: "30 Aug", names: "Chiradzulu Community Crusade", types: "Community Crusade", cities: "Blantyre" },
  { code: "MU", nation: "Mauritius", dates: "28 Aug & 29 Aug", names: "Youths Aglow Crusade Mauritius; Rhapsody End-Time Crusade - Mauritius", types: "Youths Aglow; Crusade", cities: "Port Louis, Mahebourg" },
  { code: "ME", nation: "Montenegro", dates: "4 Sep", names: "Rhapsody End-Time Crusade Montenegro", types: "Community Crusade", cities: "Podgorica" },
  ...
  { code: "PK", nation: "Pakistan", dates: "23 Aug, 23 Aug, 23 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug, 29 Aug & 29 Aug", names: "Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade; Rhapsody End-Time Crusade", types: "Crusades", cities: "Barkhan, Ghaziabad, Ghaziabad, Chichawatni, Mian Channu, Mian Channu, Khanewal, Shanti Nagar, Islamabad, Jhelum, Toba Tek Singh, Gojra, Gojra, Mananwala" },
  { code: "PA", nation: "Panama", dates: "6 Sep", names: "Panama City Crusade", types: "Mega Crusades", cities: "Panama City" },
  { code: "PG", nation: "Papua New Guinea", dates: "15 Aug, 20 Aug, 23 Aug, 31 Aug & 5 Sep", names: "Mile Community Crusade; Gaire Village Crusade; Tubusereia Village Crusade; Boroka Miracle Crusade; Mega Crusade", types: "Community; Village; Mega Crusades", cities: "Port Moresby" },
  ...
  { code: "TZ", nation: "Tanzania", dates: "28 Aug & 29 Aug", names: "Dodoma City Crusade; Dodoma Street Crusade", types: "Street Crusades", cities: "Dodoma" },
  ...
  { code: "VN", nation: "Vietnam", dates: "24 Aug, 25 Aug, 26 Aug, 26 Aug & 29 Aug", names: "Light Up Ca Mau City; Light Up Ho Chi Minh; Light Up Bac Lieu; Light Up Can Tho; Light Up Daklak", types: "Village Crusades", cities: "Ca Mau City, Ho Chi Minh City, Bac Lieu, Can Tho, Daklak" },
];
